...
export default function CategorizedTechnique({editCatTechVideo, handleAddCatTechNote, category, handleEditCatTechNote, handleTouchEnd, handleTouchDragStart,   handleDeleteCatTechNote, catTechnique, handleDeleteCatTechnique}) {
    ...
    return (
        <div id={catTechnique.id} draggable="true"  onDrag={handleDragStart} onDragEnd={handleDragEnd} onDragEnter={(event) => {event.preventDefault()}} onTouchEnd={handleTouchEnd} onTouchMove={handleTouchDragStart} style={{backgroundColor: catTechnique.color}} class="log catLog">
